...
class Box(Guide):
    ...
    def get_volume_fee(self) -> float:
        return self.__volume_fee

    def set_volume_fee(self, volume_fee: float):
        self.__volume_fee = volume_fee

    def calculate_cost(self) -> float:
        return (super().calculate_cost() * self.get_weight()) + self.__volume_fee
    ...
    def to_json(self):
        return {
            ...
            "volume_fee": self.get_volume_fee(),
            "type": "box",
    ...
    def from_json(cls, data):
        ...
        volume_fee = data.get("volume_fee")
