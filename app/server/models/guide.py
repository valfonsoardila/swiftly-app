...
class Guide:
    def __init__(self, guideNumber: str, date: date, status: str, weight: float, quantity: float, declaredValue: float, serviceType: ServiceType, isInternational: bool,sender:Sender,recipient:Recipient):
    ...
    def calculateDeliveryCost(self) -> float:
        return self.__serviceType.calculateCost(self.__weight, self.__quantity, self.__isInternational)
